...
public abstract class AbstractFindOrSaveWherePersistentMethod extends AbstractPersistentStaticMethodInvocation implements FindOrSaveWhereMethod {
    public AbstractFindOrSaveWherePersistentMethod(@Nonnull GriffonDomainHandler griffonDomainHandler) {
    ...
    protected final <T extends GriffonDomain> Object invokeInternal(@Nonnull GriffonDomainClass<T> domainClass, @Nonnull String methodName, @Nonnull Object[] arguments) {
        if (arguments.length == 1) {
            ...
            if (arg1 instanceof Map && arg2 instanceof Map) {
                return findOrSaveByParams(domainClass, (Map) arg1, (Map) arg2);
            }
        }
    ...
    @Nullable
    protected <T extends GriffonDomain> T findOrSaveByParams(@Nonnull GriffonDomainClass<T> domainClass, @Nonnull Map<String, Object> params, @Nonnull Map<String, Object> options) {
