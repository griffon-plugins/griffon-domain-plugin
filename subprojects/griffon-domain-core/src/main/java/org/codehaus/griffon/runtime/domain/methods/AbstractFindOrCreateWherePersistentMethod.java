...
public abstract class AbstractFindOrCreateWherePersistentMethod extends AbstractPersistentStaticMethodInvocation implements FindOrCreateWhereMethod {
    public AbstractFindOrCreateWherePersistentMethod(@Nonnull GriffonDomainHandler griffonDomainHandler) {
    ...
    @Nullable
    protected <T extends GriffonDomain> T findOrCreateByParams(@Nonnull GriffonDomainClass<T> domainClass, @Nonnull Map<String, Object> params) {
