...
public abstract class AbstractPersistentInstanceDynamicMethodInvocation
    ...
    public final <T extends GriffonDomain> T invoke(@Nonnull T target, @Nonnull String methodName, Object... arguments) {
        requireNonNull(target, "Argument 'target' cannot be blank");
    ...
    @Nullable
    protected abstract <T extends GriffonDomain> T invokeInternal(@Nonnull GriffonDomainClass<T> domainClass, @Nonnull GriffonDomain target, @Nonnull String methodName, @Nonnull Object[] arguments);
}