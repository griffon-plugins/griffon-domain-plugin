...
import griffon.plugins.domain.methods.ExistsMethod;
 ...
 */
public abstract class AbstractExistsPersistentMethod extends AbstractPersistentStaticMethodInvocation implements ExistsMethod {
    public AbstractExistsPersistentMethod(@Nonnull GriffonDomainHandler griffonDomainHandler) {
    ...
    protected <T extends GriffonDomain> boolean exists(@Nonnull GriffonDomainClass<T> domainClass, @Nonnull Object key) {
