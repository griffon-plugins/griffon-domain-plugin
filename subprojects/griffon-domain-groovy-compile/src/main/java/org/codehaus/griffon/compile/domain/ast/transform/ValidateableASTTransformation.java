...
public class ValidateableASTTransformation extends AbstractASTTransformation implements AnnotationHandler {
    ...
    private static final String CONSTRAINTS_EVALUATOR_NAME = "constraintsEvaluator";
    ...
    public static void addValidatableBehavior(ClassNode declaringClass, SourceUnit source) {
        ...
        // ));
        FieldExpression constraintsEvaluator = injectedField(declaringClass, CONSTRAINTS_EVALUATOR_TYPE, CONSTRAINTS_EVALUATOR_NAME);
